...
test('standard', () => {
    ...
    expect(calc.accuracy).toBeCloseTo(93.98, 1);
...
test('taiko', () => {
    ...
    expect(calc.accuracy).toBeCloseTo(84.71, 1);
...
test('fruits', () => {
    ...
    expect(calc.accuracy).toBeCloseTo(84.90, 1);
...
test('mania', () => {
    ...
    expect(calc.accuracy).toBeCloseTo(81.29, 1);
    expect(calc.rank).toBe('B');
});